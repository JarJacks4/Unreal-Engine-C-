...
#define ORT_ALL_ARGS_NONnullptr __attribute__((nonnull))
#else
#include <specstrings.h>
#define ORT_ALL_ARGS_NONnullptr
#endif
...
// Any pointer marked with _In_ or _Out_, cannot be nullptr.

// Windows users should use unicode paths when possible to bypass the MAX_PATH limitation
// Every pointer marked with _In_ or _Out_, cannot be nullptr. Caller should ensure that.
// for ReleaseXXX(...) functions, they can accept nullptr pointer.
...
struct OrtApi {
   ...
   */
  OrtStatus*(ORT_API_CALL* CreateStatus)(OrtErrorCode code, _In_ const char* msg)NO_EXCEPTION ORT_ALL_ARGS_NONnullptr;
   ...
   */
  OrtErrorCode(ORT_API_CALL* GetErrorCode)(_In_ const OrtStatus* status) NO_EXCEPTION ORT_ALL_ARGS_NONnullptr;
   ...
   */
  const char*(ORT_API_CALL* GetErrorMessage)(_In_ const OrtStatus* status)NO_EXCEPTION ORT_ALL_ARGS_NONnullptr;
   ...
   */
  void(ORT_API_CALL* ClearBoundInputs)(_Inout_ OrtIoBinding* binding_ptr) NO_EXCEPTION ORT_ALL_ARGS_NONnullptr;

  /** \brief Clears any previously set Outputs for an ::OrtIoBinding
   */
  void(ORT_API_CALL* ClearBoundOutputs)(_Inout_ OrtIoBinding* binding_ptr) NO_EXCEPTION ORT_ALL_ARGS_NONnullptr;
   ...
   * \note A nullptr pointer will be returned and no error message will be printed if the training api
   * is not supported with this build. A nullptr pointer will be returned and an error message will be
